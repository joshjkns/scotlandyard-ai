...
public class IrrelevantMovesTest {
    public static void main(){
        ...
        Map<Integer, Double> dijkstraMap = Dijkstra.dijkstraFunction(newGamestate.getSetup().graph,1);
    ...
    public static void testRemovesIrrelevant(Map<Integer,Double> dijkstraMap){
        ...
        testArray.add(new Move.SingleMove(ScotlandYard.ALL_PIECES.get(1),45, ScotlandYard.Ticket.SECRET,59));
        ...
        try{
            assert (answerArray.size() == testArray.size()-2);
